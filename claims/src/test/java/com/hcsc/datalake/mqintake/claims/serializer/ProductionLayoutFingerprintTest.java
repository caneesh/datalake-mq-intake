...
class ProductionLayoutFingerprintTest {
    ...
    @Test
    void claimsSerializerProducesProductionHeaderFingerprint() throws Exception {
        assertHeaderLength(new ClaimsRecordSerializer(), "claims.seq");
    }

    @Test
    void claimsDeclaresTheProductionWritableTypes() {
        ...
        RecordSerializer serializer = new ClaimsRecordSerializer();
